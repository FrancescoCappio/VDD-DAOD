...
if __name__ == "__main__":
    ...
    if args.dataset == "dc":
        ...
        args.imdb_name = "bdd_daytime_foggy"
        args.imdbval_name = "bdd_daytime_foggy"
        args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
    elif args.dataset == "dsa":
        args.imdb_name = "bdd_daytime_sand"
        args.imdbval_name = "bdd_daytime_sand"
        args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
    elif args.dataset == "dsn":
        args.imdb_name = "bdd_daytime_snow"
        args.imdbval_name = "bdd_daytime_snow"
        args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
    elif args.dataset == "dur":
        args.imdb_name = "bdd_dusk_rainy"
        args.imdbval_name = "bdd_dusk_rainy"
        args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
    elif args.dataset == "nc":
        args.imdb_name = "bdd_night_clear"
        args.imdbval_name = "bdd_night_clear"
        args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
    ...
    # save_name = args.dataset + '_' + args.model_dir.split("/")[-1]
    save_name = args.modelname + '/' + args.model_dir.split("/")[-1]
    ...
    for i in range(num_images):
        ...
        with torch.no_grad():
            rois, cls_prob_list, bbox_pred_list, \
            rpn_loss_cls, rpn_loss_box, \
            RCNN_loss_cls, RCNN_loss_bbox, \
            rois_label,d_pred,_,_ = fasterRCNN(im_data, im_info, gt_boxes, num_boxes, phase=1)

        cls_prob = cls_prob_list[1] * 1.0 + cls_prob_list[0] * 0.0
        bbox_pred = bbox_pred_list[1] * 1.0 + bbox_pred_list[0] * 0.0
